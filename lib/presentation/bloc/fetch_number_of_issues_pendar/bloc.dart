...
class NumberOfIssuesPendarBloc extends Bloc<NumberOfIssuesPendarEvent, NumberOfIssuesPendarState> {
  ...
  NumberOfIssuesPendarBloc(this.numberOfIssuesRepository) : super(
  ...
  void _mapNumberOfIssuesEventToState(
    ...
    try {
      ...
      final responSeNumberOfIssueForPardazeshMaliPartCo = await numberOfIssuesRepository.getNumberOfIssueForPardazeshEttelaatMaliPartCoPendar();
      ...
      final responseNumberOfIssueForBankTejaratCo = await numberOfIssuesRepository.getNumberOfIssueForBankTejaratCoPendar();
      ...
      final responseNumberOfIssueForBankParsiyanCo = await numberOfIssuesRepository.getNumberOfIssueForBankParsianCo();
      ...
      final responseNumberOfIssueForShabakeKaranSamaCo = await numberOfIssuesRepository.getNumberOfIssueForShabakeKaranSamaCo();
      ...
      final responseNumberOfIssueForFanavariVaRahehalhayeHushmandSepeherCo = await numberOfIssuesRepository.getFanavariVaRahHalhayeHushmandSepehrCo();
      ...
      final responseNumberOfIssueForBankMellat = await numberOfIssuesRepository.getNumberOfIssueForBankMellat();
